...
BLACK_WHITE     = $47   ; black paper, white ink - %01000111

start:
    im 1                ; Set interrupt mode to 1 (interrupt mode)
    call ROM_CLS        ; Call clear screen routine from ROM (externded immediate)
    ld hl,string        ; HL - address of string (register,extended immediate)
    ld b,STRING_LENGTH  ; B - length of string (register,immeidate)
loop:
    ...
    ; Let's do it again, but unrolled with the first letter capitalized
